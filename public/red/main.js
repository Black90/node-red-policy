...
// var json = JSON.stringify(eval("(" + w + ")"));
// alert(typeof json);
                                                                                            if ( w != "") {
                                                                                            var obj = JSON.parse(w);
                                                                                            for (var i = 0; i < obj.length; i++) {
                                                                                                alert(Object.getOwnPropertyNames(obj[i]));
                                                                                            };
                                                                                            tab = obj;

                                                                                            RED.view.showConflict(obj);
                                                                                            } else {alert(" no output from the jar calling");}
...
//////////////////////////////////////////////////////////////////////////: the end of the service
    ...
    function loadFlows() {
        ///////////////////////////////////////////////////////////////////////////  here
                     RED.notify("<strong>Notification</strong>: load the flow ","error")
        $.ajax({
            headers: {
                "Accept":"application/json"
            },
