...
RED.editor = (function() {
    ...
    function showEditDialog(node) {
        ...
        //  //////////////////////////// this methode is modified for the policy add feature
        // editing_node = node;               
        // RED.view.state(RED.state.EDITING);

        //                                        ///////// Create an Html element using javascript and than add it to one of the fragments which then will be responsible for the policy
            

        //      //var node = document.createElement("BUTTON");                 // Create a <li> node
        //      //var textnode = document.createTextNode("add_tab");         // Create a text node
        //     // node.appendChild(textnode);                              // Append the text to <li>
        //     // document.getElementById($('#fragment-2').attr('id')).appendChild(node);

        //   RED.notify( node.type,"success");
        //    if ( node.type == "test"){ 
           
        //    $("#fragment-1").html($("script[data-template-name='"+node.type+"']").html());
        //    } 
        //    else {
        //   $("#fragment-1").html($("script[data-template-name='"+node.type+"']").html());
        //   $("#fragment-2").html($("script[data-template-name='"+ "function" +"']").html());
        //   }
        ...
        // var node = document.createElement("BUTTON");                // Create a <li> node
        // node.setAttribute("id", "show_policy");
        // //class="btn btn-mini" id="node-lock" style="margin-top: 4px;"
        // node.setAttribute("class", "btn btn-mini");
        // node.setAttribute("style", "margin-top: 4px;");
        // var textnode = document.createTextNode("show Policy");         // Create a text node
        // node.appendChild(textnode);                              // Append the text to <li>
        // // document.getElementById($('#dialog-form').attr('id')).appendChild(node);
        // document.getElementById($("script[data-template-name='"+node.type+"']").html().attr('id')).appendChild(node);
        //   // $(node).on( "click", show );
        //   // function show(){ 
        //   //   alert("you are trying to see the policy sorry but it is not yet ready"); 
        //   //   alert("the policy is " +this.plicy);
