...
RED.nodes = (function() {
    ...
    var registry = (function() {
        ...
        var exports = {
            ...
            getNodeSet: function(id) {
                ///////////////////////////////////////////////////////////////here
                RED.notify("<strong>Notification</strong>: get the node set","error")
                return nodeSets[id];
            },
            ...
            registerNodeType: function(nt,def) {
                 ///////////////////////////////////////////////////////////////here
               // RED.notify("<strong>Notification</strong>: register node ","error")
    ...
    function getID() {
         ///////////////////////////////////////////////////////////////here
                RED.notify("<strong>Notification</strong>: get ID when is it used ","error")
    ...
    function addLink(l) {
        ///////////////////////////////////////////////////////////////////////////  here
        RED.notify("<strong>Notification</strong>: addding a link","error")
        links.push(l);
    }
    ...
    function loadNodes(newNodesObj) {
        try {
             var i;
            var n;
            var newNodes;
            ...
            if (typeof newNodesObj === "string") {
                ...
                RED.notify( typeof newNodes,"error");
                for (var i = 0; i < newNodes.length; i++) {
                  if( newNodes[i].type != "tab"){  array_nodes.push({"name": newNodes[i].type, "id": newNodes[i].id, "outputs":newNodes[i].wires.length  });   }
                };
